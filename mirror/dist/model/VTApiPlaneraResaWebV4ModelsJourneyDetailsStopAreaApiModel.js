 ...
 * @version v4
 */
var VTApiPlaneraResaWebV4ModelsJourneyDetailsStopAreaApiModel = /*#__PURE__*/function () {
  /**
   ...
   */
  function VTApiPlaneraResaWebV4ModelsJourneyDetailsStopAreaApiModel() {
    _classCallCheck(this, VTApiPlaneraResaWebV4ModelsJourneyDetailsStopAreaApiModel);
   ...
   */
  _createClass(VTApiPlaneraResaWebV4ModelsJourneyDetailsStopAreaApiModel, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('tariffZone1')) {
          obj['tariffZone1'] = _VTApiPlaneraResaWebV4ModelsJourneyDetailsTariffZoneApiModel["default"].constructFromObject(data['tariffZone1']);
        }
        if (data.hasOwnProperty('tariffZone2')) {
          obj['tariffZone2'] = _VTApiPlaneraResaWebV4ModelsJourneyDetailsTariffZoneApiModel["default"].constructFromObject(data['tariffZone2']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data['tariffZone1']) {
        // data not null
        _VTApiPlaneraResaWebV4ModelsJourneyDetailsTariffZoneApiModel["default"].validateJSON(data['tariffZone1']);
      }
      // validate the optional field `tariffZone2`
      if (data['tariffZone2']) {
        // data not null
        _VTApiPlaneraResaWebV4ModelsJourneyDetailsTariffZoneApiModel["default"].validateJSON(data['tariffZone2']);
      }
      return true;
    }
  }]);
...
var _default = VTApiPlaneraResaWebV4ModelsJourneyDetailsStopAreaApiModel;
