...
var _VTApiPlaneraResaCoreModelsSeverity = _interopRequireDefault(require("./VTApiPlaneraResaCoreModelsSeverity"));
 ...
 * @version v4
 */
var VTApiPlaneraResaCoreModelsNote = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>VTApiPlaneraResaCoreModelsNote</code>.
   * @alias module:model/VTApiPlaneraResaCoreModelsNote
   */
  function VTApiPlaneraResaCoreModelsNote() {
    _classCallCheck(this, VTApiPlaneraResaCoreModelsNote);
   ...
   */
  _createClass(VTApiPlaneraResaCoreModelsNote, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('severity')) {
          obj['severity'] = _VTApiPlaneraResaCoreModelsSeverity["default"].constructFromObject(data['severity']);
        }
...
var _default = VTApiPlaneraResaCoreModelsNote;
