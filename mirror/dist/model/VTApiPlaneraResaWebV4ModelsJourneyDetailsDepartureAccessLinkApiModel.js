...
var _VTApiPlaneraResaWebV4ModelsJourneyDetailsCallApiModel = _interopRequireDefault(require("./VTApiPlaneraResaWebV4ModelsJourneyDetailsCallApiModel"));
var _VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkEndpointApiModel = _interopRequireDefault(require("./VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkEndpointApiModel"));
var _VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkSegmentApiModel = _interopRequireDefault(require("./VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkSegmentApiModel"));
 ...
 * @version v4
 */
var VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel = /*#__PURE__*/function () {
  /**
   ...
   */
  function VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel() {
    _classCallCheck(this, VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel);
   ...
   */
  _createClass(VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('origin')) {
          obj['origin'] = _VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkEndpointApiModel["default"].constructFromObject(data['origin']);
        }
        if (data.hasOwnProperty('destination')) {
          obj['destination'] = _VTApiPlaneraResaWebV4ModelsJourneyDetailsCallApiModel["default"].constructFromObject(data['destination']);
        }
        ...
        if (data.hasOwnProperty('segments')) {
          obj['segments'] = _ApiClient["default"].convertToType(data['segments'], [_VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkSegmentApiModel["default"]]);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data['origin']) {
        // data not null
        _VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkEndpointApiModel["default"].validateJSON(data['origin']);
      }
      // validate the optional field `destination`
      if (data['destination']) {
        // data not null
        _VTApiPlaneraResaWebV4ModelsJourneyDetailsCallApiModel["default"].validateJSON(data['destination']);
      }
      if (data['notes']) {
        // data not null
      ...
      if (data['segments']) {
        ...
        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
            ...
            _VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkSegmentApiModel["default"].validateJSON(_item2);
          }
        } catch (err) {
          _iterator3.e(err);
        } finally {
...
var _default = VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel;
