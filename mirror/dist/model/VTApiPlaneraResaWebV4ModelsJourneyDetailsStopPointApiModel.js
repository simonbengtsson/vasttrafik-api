...
var _VTApiPlaneraResaWebV4ModelsJourneyDetailsStopAreaApiModel = _interopRequireDefault(require("./VTApiPlaneraResaWebV4ModelsJourneyDetailsStopAreaApiModel"));
 ...
 * @version v4
 */
var VTApiPlaneraResaWebV4ModelsJourneyDetailsStopPointApiModel = /*#__PURE__*/function () {
  /**
   ...
   */
  function VTApiPlaneraResaWebV4ModelsJourneyDetailsStopPointApiModel(gid, name) {
    _classCallCheck(this, VTApiPlaneraResaWebV4ModelsJourneyDetailsStopPointApiModel);
   ...
   */
  _createClass(VTApiPlaneraResaWebV4ModelsJourneyDetailsStopPointApiModel, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('stopArea')) {
          obj['stopArea'] = _VTApiPlaneraResaWebV4ModelsJourneyDetailsStopAreaApiModel["default"].constructFromObject(data['stopArea']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(VTApiPlaneraResaWebV4ModelsJourneyDetailsStopPointApiModel.RequiredProperties),
        _step;
      try {
      ...
      if (data['stopArea']) {
        // data not null
        _VTApiPlaneraResaWebV4ModelsJourneyDetailsStopAreaApiModel["default"].validateJSON(data['stopArea']);
      }
      return true;
    }
  }]);
...
var _default = VTApiPlaneraResaWebV4ModelsJourneyDetailsStopPointApiModel;
