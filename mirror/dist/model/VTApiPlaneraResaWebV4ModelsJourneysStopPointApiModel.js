...
var _VTApiPlaneraResaWebV4ModelsJourneysStopAreaApiModel = _interopRequireDefault(require("./VTApiPlaneraResaWebV4ModelsJourneysStopAreaApiModel"));
 ...
 * @version v4
 */
var VTApiPlaneraResaWebV4ModelsJourneysStopPointApiModel = /*#__PURE__*/function () {
  /**
   ...
   */
  function VTApiPlaneraResaWebV4ModelsJourneysStopPointApiModel(gid, name) {
    _classCallCheck(this, VTApiPlaneraResaWebV4ModelsJourneysStopPointApiModel);
   ...
   */
  _createClass(VTApiPlaneraResaWebV4ModelsJourneysStopPointApiModel, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('stopArea')) {
          obj['stopArea'] = _VTApiPlaneraResaWebV4ModelsJourneysStopAreaApiModel["default"].constructFromObject(data['stopArea']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(VTApiPlaneraResaWebV4ModelsJourneysStopPointApiModel.RequiredProperties),
        _step;
      try {
      ...
      if (data['stopArea']) {
        // data not null
        _VTApiPlaneraResaWebV4ModelsJourneysStopAreaApiModel["default"].validateJSON(data['stopArea']);
      }
      return true;
    }
  }]);
...
var _default = VTApiPlaneraResaWebV4ModelsJourneysStopPointApiModel;
