...
var _VTApiPlaneraResaWebV4ModelsJourneysJourneyApiModel = _interopRequireDefault(require("./VTApiPlaneraResaWebV4ModelsJourneysJourneyApiModel"));
 ...
 * @version v4
 */
var VTApiPlaneraResaWebV4ModelsJourneysGetJourneysResponse = /*#__PURE__*/function () {
  /**
   ...
   */
  function VTApiPlaneraResaWebV4ModelsJourneysGetJourneysResponse() {
    _classCallCheck(this, VTApiPlaneraResaWebV4ModelsJourneysGetJourneysResponse);
   ...
   */
  _createClass(VTApiPlaneraResaWebV4ModelsJourneysGetJourneysResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('results')) {
          obj['results'] = _ApiClient["default"].convertToType(data['results'], [_VTApiPlaneraResaWebV4ModelsJourneysJourneyApiModel["default"]]);
        }
      ...
      if (data['results']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _VTApiPlaneraResaWebV4ModelsJourneysJourneyApiModel["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = VTApiPlaneraResaWebV4ModelsJourneysGetJourneysResponse;
