 ...
 * @version v4
 */
var VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel = /*#__PURE__*/function () {
  /**
   ...
   */
  function VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel() {
    _classCallCheck(this, VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel);
   ...
   */
  _createClass(VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('origin')) {
          obj['origin'] = _VTApiPlaneraResaWebV4ModelsJourneyDetailsCallApiModel["default"].constructFromObject(data['origin']);
        }
        if (data.hasOwnProperty('destination')) {
          obj['destination'] = _VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkEndpointApiModel["default"].constructFromObject(data['destination']);
        }
    ...
    value: function validateJSON(data) {
      ...
      if (data['origin']) {
        // data not null
        _VTApiPlaneraResaWebV4ModelsJourneyDetailsCallApiModel["default"].validateJSON(data['origin']);
      }
      // validate the optional field `destination`
      if (data['destination']) {
        // data not null
        _VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkEndpointApiModel["default"].validateJSON(data['destination']);
      }
      if (data['notes']) {
        // data not null
...
var _default = VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel;
