 ...
 * @version v4
 */
var VTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel = /*#__PURE__*/function () {
  /**
   ...
   */
  function VTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel() {
    _classCallCheck(this, VTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel);
   ...
   */
  _createClass(VTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('destination')) {
          obj['destination'] = _VTApiPlaneraResaWebV4ModelsJourneysLinkEndpointApiModel["default"].constructFromObject(data['destination']);
        }
    ...
    value: function validateJSON(data) {
      ...
      if (data['destination']) {
        // data not null
        _VTApiPlaneraResaWebV4ModelsJourneysLinkEndpointApiModel["default"].validateJSON(data['destination']);
      }
      if (data['notes']) {
        // data not null
...
var _default = VTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel;
