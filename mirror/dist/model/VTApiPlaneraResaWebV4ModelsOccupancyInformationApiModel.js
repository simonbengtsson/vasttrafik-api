...
var _VTApiPlaneraResaWebV4ModelsOccupancyInformationSource = _interopRequireDefault(require("./VTApiPlaneraResaWebV4ModelsOccupancyInformationSource"));
var _VTApiPlaneraResaWebV4ModelsOccupancyLevel = _interopRequireDefault(require("./VTApiPlaneraResaWebV4ModelsOccupancyLevel"));
 ...
 * @version v4
 */
var VTApiPlaneraResaWebV4ModelsOccupancyInformationApiModel = /*#__PURE__*/function () {
  /**
   ...
   */
  function VTApiPlaneraResaWebV4ModelsOccupancyInformationApiModel() {
    _classCallCheck(this, VTApiPlaneraResaWebV4ModelsOccupancyInformationApiModel);
   ...
   */
  _createClass(VTApiPlaneraResaWebV4ModelsOccupancyInformationApiModel, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('level')) {
          obj['level'] = _VTApiPlaneraResaWebV4ModelsOccupancyLevel["default"].constructFromObject(data['level']);
        }
        if (data.hasOwnProperty('source')) {
          obj['source'] = _VTApiPlaneraResaWebV4ModelsOccupancyInformationSource["default"].constructFromObject(data['source']);
        }
      }
      return obj;
    }
...
var _default = VTApiPlaneraResaWebV4ModelsOccupancyInformationApiModel;
