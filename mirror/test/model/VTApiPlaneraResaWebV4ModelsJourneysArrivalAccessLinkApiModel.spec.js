...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PlaneraResa.VTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel();
  });
  ...
  describe('VTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel', function() {
    it('should create an instance of VTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel', function() {
      // uncomment below and update the code to test VTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel
      //var instance = new PlaneraResa.VTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel();
      //expect(instance).to.be.a(PlaneraResa.VTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel);
    });
