...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PlaneraResa.VTApiPlaneraResaWebV4ModelsPositionsLineDetailsApiModel();
  });
  ...
  describe('VTApiPlaneraResaWebV4ModelsPositionsLineDetailsApiModel', function() {
    it('should create an instance of VTApiPlaneraResaWebV4ModelsPositionsLineDetailsApiModel', function() {
      // uncomment below and update the code to test VTApiPlaneraResaWebV4ModelsPositionsLineDetailsApiModel
      //var instance = new PlaneraResa.VTApiPlaneraResaWebV4ModelsPositionsLineDetailsApiModel();
      //expect(instance).to.be.a(PlaneraResa.VTApiPlaneraResaWebV4ModelsPositionsLineDetailsApiModel);
    });
