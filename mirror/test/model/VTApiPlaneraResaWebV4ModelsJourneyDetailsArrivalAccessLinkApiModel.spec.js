...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PlaneraResa.VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel();
  });
  ...
  describe('VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel', function() {
    it('should create an instance of VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel', function() {
      // uncomment below and update the code to test VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel
      //var instance = new PlaneraResa.VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel();
      //expect(instance).to.be.a(PlaneraResa.VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel);
    });
