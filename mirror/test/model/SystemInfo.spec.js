...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SystemInfo', function() {
      beforeEach(function() {
        instance = new Reseplaneraren.SystemInfo();
      });

      it('should create an instance of SystemInfo', function() {
        // TODO: update the code to test SystemInfo
        expect(instance).to.be.a(Reseplaneraren.SystemInfo);
      });

      it('should have the property timetableInfo (base name: "TimetableInfo")', function() {
        // TODO: update the code to test the property timetableInfo
        expect(instance).to.have.property('timetableInfo');
        // expect(instance.timetableInfo).to.be(expectedValueLiteral);
      });
