...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PlaneraResa.VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsCallDetailsApiModel();
  });
  ...
  describe('VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsCallDetailsApiModel', function() {
    it('should create an instance of VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsCallDetailsApiModel', function() {
      // uncomment below and update the code to test VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsCallDetailsApiModel
      //var instance = new PlaneraResa.VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsCallDetailsApiModel();
      //expect(instance).to.be.a(PlaneraResa.VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsCallDetailsApiModel);
    });
