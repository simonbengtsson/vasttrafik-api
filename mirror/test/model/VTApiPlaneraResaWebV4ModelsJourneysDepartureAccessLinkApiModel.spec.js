...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PlaneraResa.VTApiPlaneraResaWebV4ModelsJourneysDepartureAccessLinkApiModel();
  });
  ...
  describe('VTApiPlaneraResaWebV4ModelsJourneysDepartureAccessLinkApiModel', function() {
    it('should create an instance of VTApiPlaneraResaWebV4ModelsJourneysDepartureAccessLinkApiModel', function() {
      // uncomment below and update the code to test VTApiPlaneraResaWebV4ModelsJourneysDepartureAccessLinkApiModel
      //var instance = new PlaneraResa.VTApiPlaneraResaWebV4ModelsJourneysDepartureAccessLinkApiModel();
      //expect(instance).to.be.a(PlaneraResa.VTApiPlaneraResaWebV4ModelsJourneysDepartureAccessLinkApiModel);
    });
