...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PlaneraResa.VTApiPlaneraResaWebV4ModelsJourneysConnectionLinkApiModel();
  });
  ...
  describe('VTApiPlaneraResaWebV4ModelsJourneysConnectionLinkApiModel', function() {
    it('should create an instance of VTApiPlaneraResaWebV4ModelsJourneysConnectionLinkApiModel', function() {
      // uncomment below and update the code to test VTApiPlaneraResaWebV4ModelsJourneysConnectionLinkApiModel
      //var instance = new PlaneraResa.VTApiPlaneraResaWebV4ModelsJourneysConnectionLinkApiModel();
      //expect(instance).to.be.a(PlaneraResa.VTApiPlaneraResaWebV4ModelsJourneysConnectionLinkApiModel);
    });
