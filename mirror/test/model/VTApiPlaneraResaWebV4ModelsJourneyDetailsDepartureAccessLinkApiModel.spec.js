...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PlaneraResa.VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel();
  });
  ...
  describe('VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel', function() {
    it('should create an instance of VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel', function() {
      // uncomment below and update the code to test VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel
      //var instance = new PlaneraResa.VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel();
      //expect(instance).to.be.a(PlaneraResa.VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel);
    });
