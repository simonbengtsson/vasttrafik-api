...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PlaneraResa.VTApiPlaneraResaWebV4ModelsJourneysLineApiModel();
  });
  ...
  describe('VTApiPlaneraResaWebV4ModelsJourneysLineApiModel', function() {
    it('should create an instance of VTApiPlaneraResaWebV4ModelsJourneysLineApiModel', function() {
      // uncomment below and update the code to test VTApiPlaneraResaWebV4ModelsJourneysLineApiModel
      //var instance = new PlaneraResa.VTApiPlaneraResaWebV4ModelsJourneysLineApiModel();
      //expect(instance).to.be.a(PlaneraResa.VTApiPlaneraResaWebV4ModelsJourneysLineApiModel);
    });
