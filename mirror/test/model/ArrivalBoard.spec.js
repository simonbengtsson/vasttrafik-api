...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ArrivalBoard', function() {
      beforeEach(function() {
        instance = new Reseplaneraren.ArrivalBoard();
      });

      it('should create an instance of ArrivalBoard', function() {
        // TODO: update the code to test ArrivalBoard
        expect(instance).to.be.a(Reseplaneraren.ArrivalBoard);
      });
      ...
      it('should have the property arrival (base name: "Arrival")', function() {
        // TODO: update the code to test the property arrival
        expect(instance).to.have.property('arrival');
        // expect(instance.arrival).to.be(expectedValueLiteral);
      });
