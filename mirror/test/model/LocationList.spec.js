  ...
  describe('(package)', function() {
    describe('LocationList', function() {
      ...
      it('should create an instance of LocationList', function() {
        // TODO: update the code to test LocationList
      ...
      it('should have the property stopLocation (base name: "StopLocation")', function() {
        // TODO: update the code to test the property stopLocation
        expect(instance).to.have.property('stopLocation');
        // expect(instance.stopLocation).to.be(expectedValueLiteral);
      });

      it('should have the property coordLocation (base name: "CoordLocation")', function() {
        // TODO: update the code to test the property coordLocation
        expect(instance).to.have.property('coordLocation');
        // expect(instance.coordLocation).to.be(expectedValueLiteral);
      });
