...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PlaneraResa.VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsLineDetailsApiModel();
  });
  ...
  describe('VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsLineDetailsApiModel', function() {
    it('should create an instance of VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsLineDetailsApiModel', function() {
      // uncomment below and update the code to test VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsLineDetailsApiModel
      //var instance = new PlaneraResa.VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsLineDetailsApiModel();
      //expect(instance).to.be.a(PlaneraResa.VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsLineDetailsApiModel);
    });
