...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PlaneraResa.VTApiPlaneraResaWebV4ModelsJourneyDetailsConnectionLinkApiModel();
  });
  ...
  describe('VTApiPlaneraResaWebV4ModelsJourneyDetailsConnectionLinkApiModel', function() {
    it('should create an instance of VTApiPlaneraResaWebV4ModelsJourneyDetailsConnectionLinkApiModel', function() {
      // uncomment below and update the code to test VTApiPlaneraResaWebV4ModelsJourneyDetailsConnectionLinkApiModel
      //var instance = new PlaneraResa.VTApiPlaneraResaWebV4ModelsJourneyDetailsConnectionLinkApiModel();
      //expect(instance).to.be.a(PlaneraResa.VTApiPlaneraResaWebV4ModelsJourneyDetailsConnectionLinkApiModel);
    });
